# Sui Protocol Core & CLI

<!--
Module: Sui Core Documentation
Purpose: Provides an overview of the Sui blockchain protocol, architecture, and CLI usage.
Usage: Reference guide for developers setting up and interacting with the Sui network.
-->
